...
* Es gibt eine zentrale Kameraperspektive (weitere können gerne eigenständig eingebracht werden), die im hinteren Teil des Raumes positioniert ist.
...
* Dozierende:
    * Aufnahmetechnik
* Studierende:
    * Skripte - Skripte (verblindet und nicht verblindet) per Mail an kirstin.schmidt@ph-karlsruhe.de (eine Mail je Gruppe ist ausreichend). Verweisen Sie in der Mail zudem darauf, auf welchen Fall Sie sich beziehen
    * Rolleneinteilung
